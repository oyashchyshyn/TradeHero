...
internal class FuturesUsdEndpoints : IFuturesUsdEndpoints
{
    ...
    public async Task<ActionResult> SetFuturesUsdWalletBalancesAsync(IStrategyStore store, int maxRetries = 5, CancellationToken cancellationToken = default)
    {
        try
        {
    ...
    public async Task<ActionResult> SetFuturesUsdExchangeInfoAsync(IStrategyStore store, int maxRetries = 5, CancellationToken cancellationToken = default)
    {
        try
        {
            for (var i = 0; i < maxRetries; i++)
    ...
    public async Task<ActionResult> SetFuturesUsdPositionInfoAsync(IStrategyStore store, int maxRetries = 5, CancellationToken cancellationToken = default)
    {
        try
        {
            for (var i = 0; i < maxRetries; i++)
    ...
    public async Task<ActionResult> SetFuturesUsdStreamListenKeyAsync(IStrategyStore store, int maxRetries = 5, CancellationToken cancellationToken = default)
    {
        try
        {
            for (var i = 0; i < maxRetries; i++)
    ...
    public async Task<ActionResult> ChangeMarginTypeToAllPositionsAsync(IStrategyStore store, FuturesMarginType marginType, CancellationToken cancellationToken = default)
    {
        try
        {
    ...
    public async Task<ActionResult> ChangeLeverageToAllPositionsAsync(IStrategyStore store, int leverage, int maxRetries = 5, CancellationToken cancellationToken = default)
    {
        try
        {
    ...
    public async Task<ActionResult> UpdateStreamListerKeyAsync(IStrategyStore store, int maxRetries = 5, CancellationToken cancellationToken = default)
    {
        try
        {
            for (var i = 0; i < maxRetries; i++)
    ...
    public async Task<ActionResult> DestroyStreamListerKeyAsync(IStrategyStore store, int maxRetries = 5, CancellationToken cancellationToken = default)
    {
        try
        {
            for (var i = 0; i < maxRetries; i++)
