...
internal class UpdateConnectionCommand : IMenuCommand
{
    private readonly ILogger<UpdateConnectionCommand> _logger;
    private readonly ITelegramService _telegramService;
    private readonly TelegramMenuStore _telegramMenuStore;

    public UpdateConnectionCommand(
        ILogger<UpdateConnectionCommand> logger,
    ...
    public string Id => _telegramMenuStore.TelegramButtons.ConnectionsUpdate;
