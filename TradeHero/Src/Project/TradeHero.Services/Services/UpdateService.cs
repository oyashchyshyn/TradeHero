...
internal class UpdateService : IUpdateService
{
        ...
        CancellationToken cancellationToken = default)
    {
        try
        {
            ...
            var appFilePath = Path.Combine(_environmentService.GetBasePath(), releaseVersion.AppName);
            var updaterFilePath = Path.Combine(_environmentService.GetBasePath(), releaseVersion.UpdaterName);
